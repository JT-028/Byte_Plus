...
import '../../utils/update_product_images.dart';
...
class _AdminStoresPageState extends State<AdminStoresPage> {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          OutlinedButton.icon(
            onPressed: () => _updateProductImages(),
            icon: const Icon(Iconsax.image, size: 18),
            label: const Text('Update Images'),
            style: OutlinedButton.styleFrom(
  ...
  Future<void> _updateProductImages() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              'This will upload all product images from local assets to Cloudinary and update the menu items.\n\nThis may take a few minutes.\n\nContinue?',
              style: TextStyle(
                color:
                    isDark
                        ? AppColors.textSecondaryDark
    ...
    try {
      // Call the image updater
      await ProductImageUpdater.updateAllImages(
        onProgress: (message) {
          debugPrint(message);
        },
      );
      ...
      showDialog(
        ...
        builder:
            (context) => AlertDialog(
              ...
              content: Text(
                'Product images have been uploaded and updated successfully!',
                style: TextStyle(
                  color:
                      isDark
                          ? AppColors.textSecondaryDark
